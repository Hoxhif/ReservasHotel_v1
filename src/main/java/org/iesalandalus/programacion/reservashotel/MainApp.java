    ...
    public class MainApp {
        ...
        private static void insertarReserva(){
            try{
                ...
                Habitacion habitacionDisponible = consultarDisponibilidad(nuevaReserva.getHabitacion().getTipoHabitacion(), nuevaReserva.getFechaInicioReserva(), nuevaReserva.getFechaInicioReserva());
                if (habitacionDisponible !=null) {
                    reservas.insertar(nuevaReserva);
                    System.out.println("Reserva creada satisfactoriamente");
                }else System.out.println("No se puede realizar la reserva en esas fechas. No se encuentra disponible la habitación");
            }catch (OperationNotSupportedException e){
                System.out.println(e.getMessage());
            }
        }
        ...
        private static Reserva[] getReservasAnulables (Reserva[] reservasAAnular){
            ...
            for (Reserva reserva: reservaAnulables){
